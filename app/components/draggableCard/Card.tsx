...
export const Card: FC<CardProps> = ({ id, text, index, moveCard }) => {
  ...
  const { isChangesOpen, toggleChangesModalOpen } = useContext(SidebarContext);
      ...
      <div
        ...
        className={`w-[210px] ${
          filterModalOpen || isTeamOpen || isWorkFlowOpen || isBoardOpen
            ? ""
            : "relative group"
        }  sm:w-[240px] mb-3 rounded-md  bg-white hover:shadow-[0_1px_3px_-1px_#0003,0_3px_9px_-3px_#0000001a] dark:bg-[#161b26] shadow-[#364e7e1a]  shadow-lg border-[1px] border-[#e4e8eb] dark:text-white dark:border-[#1f2532] dark:border-[1px]`}
      >
        <div
        ...
        >
                ...
                >
                  ...
                  <div className="w-[25%] max-lg:w-[100%]">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <h6 class="my-2 font-bold text-sm text-[#2d78a4]">
                        Edit
                      </h6>
                    </div>
                    <div className="my-3">
                    ...
                    <h4 class="my-2 font-light text-sm text-[#8a8a8a]">
                      Labels
                    </h4>
                    <button
                      type="button"
          ...
          <div className="bg-[#fcfae3] dark:bg-[#364159] p-1 rounded-md flex justify-between mt-2 gap-1 items-center w-10">
            ...
            <p className="text-[#1f2532] text-[12px] dark:text-[#f6f6f6]">C</p>
          </div>
