...
interface completedTableComponentProps {
  isScheduledViewFive: boolean;
  toggleScheduledTable: () => void;
}
const CompleteTable: FC<completedTableComponentProps> = ({
  isScheduledViewFive,
    ...
    <div className="my-3 w-full">
      <div
        className={`shadow-md rounded-[12px] p-[8px] bg-white whitespace-nowrap dark:bg-[#1f2532] ${
          isScheduledViewFive ? "w-fit" : "w-full"
        }`}
        id="tableBody"
      >
        <div
        ...
        >
          ...
          <div className="flex gap-2 py-4 px-5">
            <a
              data-tooltip-id="stories-click5"
            ...
            <a
              data-tooltip-id="points-completed5"
              data-tooltip-place="top"
              data-tooltip-content="Points Completed"
            >
              <Tooltip
                id="points-completed5"
                style={{
                  backgroundColor: dark ? "#2d3545" : "",
                  color: dark ? "#fff" : "",
                }}
