        ...
        {isScheduledView && (
          <table className="w-full">
            ...
            <tbody className="bg-white dark:bg-[#1f2532]">
              ...
              <tr className="text-gray-700">
                <td className="px-4  border-r border-t-[1px] sticky left-[0px] z-10 bg-white flex-1 w-6 dark:bg-[#1f2532]">
                  <svg
                    viewBox="0 0 20 20"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <td className="px-4 text-ms font-semibold border-r-[#00000005] border-r-[3px] border-t-[#00000005] border-t-[1px] sticky left-[30px] z-10 bg-white flex-1 w-6 dark:bg-[#1f2532]">
                  <input
                    className="border-gray-300 rounded h-4 w-4 dark:bg-[#161b26]"
                    type="checkbox"
                  />
