      ...
      >
        ...
        >
          ...
          <div className="flex gap-2 py-4 px-5">
            <a
              data-tooltip-id="stories-click4"
            ...
            <a
              data-tooltip-id="points-completed4"
              data-tooltip-place="top"
              data-tooltip-content="Points Completed"
            >
              <Tooltip
                id="points-completed4"
                style={{
                  backgroundColor: dark ? "#2d3545" : "",
                  color: dark ? "#fff" : "",
                }}
                  ...
                  return (
                    ...
                    >
                      <td
                        className={`px-4 ${
                          isLastItem ? "" : "border-b"
                        }  border-r border-t-[#00000005] dark:border-r-0 border-t-[3px] ${
                          filterModalOpen ||
                          isWorkFlowOpen ||
                          isTeamOpen ||
                          isHovered ||
                      ...
                      <td
                        className={`px-4 text-ms font-semibold  ${
                          isLastItem ? "" : "border-b"
                        } border-r-[#00000005] border-r-[3px] border-t-[#00000005] border-t-[3px] ${
                          filterModalOpen ||
                          isWorkFlowOpen ||
                          isTeamOpen ||
                          isHovered ||
