...
interface DevelopmenTableComponentProps {
  isScheduledViewTwo: boolean;
  toggleScheduledTable: () => void;
}
const DevelopmentTable: FC<DevelopmenTableComponentProps> = ({
  isScheduledViewTwo,
    ...
    <div className="my-3 w-full">
      <div
        className={`shadow-md rounded-[12px] p-[8px] bg-white whitespace-nowrap dark:bg-[#1f2532] ${
          isScheduledViewTwo ? "w-fit" : "w-full"
        }`}
        id="tableBody"
      >
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white dark:bg-[#1f2532]">
              <tr className="text-gray-700">
                <td className="px-4 border-b border-r border-t-[1px] sticky left-[0px] z-10 bg-white flex-1 w-6 dark:bg-[#1f2532]">
                  <svg
                    viewBox="0 0 20 20"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <td className="px-4 text-ms font-semibold  border-b border-r-[#00000005] border-r-[3px] border-t-[#00000005] border-t-[1px] sticky left-[30px] z-10 bg-white flex-1 w-6 dark:bg-[#1f2532]">
                  <input
                    className="border-gray-300 rounded h-4 w-4 dark:bg-[#161b26]"
                    type="checkbox"
                  />
                ...
                <td className="px-4 text-sm  border-b border-t-[#00000005] border-t-[1px] border-l-[#00000005] border-l-[3px] sticky right-[0px] z-10 bg-white flex-1 w-6 dark:bg-[#1f2532]">
                  <li className="hover:bg-[#e4e8eb] hover:cursor-pointer px-2 py-1 rounded-md leading-3 list-none">
                    <svg
                      viewBox="0 0 20 20"
                      fill="none"
