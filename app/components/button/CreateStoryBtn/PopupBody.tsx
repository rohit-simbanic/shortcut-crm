...
const PopupBody: any = (close: () => void) => {
  ...
  return (
    <div className="dark:bg-darkBgDefault">
      ...
      <div
        className="content h-[480px] overflow-y-scroll flex max-lg:flex-col gap-4 px-6"
        id="style-2"
      >
        <div className="w-[75%] max-lg:w-[100%]">
          ...
          <h4 className="mb-2 font-bold dark:text-[white] text-[#444] text-[15px] pt-2 pb-0">
            Description <span className="italic font-light ml-2">optional</span>
          </h4>
          <form className="my-2">
            <div
            ...
            >
              ...
              {isWrite === 1 ? (
                <div className="pb-2 px-4 bg-white rounded-b-lg dark:bg-gray-800 xl:before:content-[''] xl:before:block xl:before:relative xl:before:w-[94.2%] xl:before:ml-[48.8px] xl:before:border-t-[1px] xl:before:border-[#e4e8eb] border-r-[1px] border-b-[1px] border-l-[1px] border-[#e4e8eb]">
                ...
                <div className="pb-2 px-4 bg-white rounded-b-lg dark:bg-gray-800 border-r-[1px] border-b-[1px] border-l-[1px] border-[#e4e8eb] xl:before:content-[''] xl:before:block xl:before:relative xl:before:w-[80.9%] xl:before:ml-[124px] xl:before:border-t-[1px] xl:before:border-[#e4e8eb]">
                  <label htmlFor="editor" className="sr-only">
                    Publish post
                  </label>
                  <textarea
          ...
          <button
            type="button"
            className="border-[1px] border-[#e4e8eb] dark:border-[#3f4a5f] rounded-md px-1 py-1 hover:bg-white dark:hover:bg-[#161b26] hover:shadow-[0_1px_0_#0000001f] text-xs dark:text-[#f6f6f6]"
          >
        ...
        <div className="w-[25%] max-lg:w-[100%]">
          ...
          <div className="my-3">
            <button className="border-[1px] border-gray-200 dark:border-gray-500 flex items-center gap-4 w-full py-2 px-1 rounded hover:shadow hover:border-[#999]">
              <button
          ...
          <div className="flex items-center justify-between">
            ...
            <h6 className="my-2 font-bold text-sm text-[#2d78a4]">Edit</h6>
          </div>
          <div className="my-3">
            <button className="border-[1px] border-gray-200 dark:border-gray-500 flex items-center gap-4 w-full py-2 px-1 hover:rounded hover:shadow hover:border-[#999] dark:hover:bg-[#161b26]">
              <svg
          ...
          <h4 className="my-2 font-light text-sm text-[#8a8a8a]">Labels</h4>
          <button
            type="button"
            className="border-[1px] border-[#e4e8eb] dark:border-[#3f4a5f] rounded-md px-1 py-1 hover:bg-white hover:shadow-[0_1px_0_#0000001f] text-xs dark:text-[#f6f6f6] mb-5 dark:hover:bg-[#161b26]"
          >
            <span className="text-[#13ae47] font-bold">+</span> Add Labels
          </button>
        </div>
      </div>
      <div className="footer bg-white dark:bg-[#161b26f2] border-t-[1px] dark:border-[#3f4a5f] border-[#e4e8eb] py-4 flex justify-between px-4 rounded-bl-[12px] rounded-br-[12px]">
        ...
        <div className="flex">
          <div className="flex gap-3 items-center px-2 py-1 hover:bg-[#e4e8eb] dark:hover:bg-[black] dark:hover:border-[1px] dark:hover:border-[#e4e8eb] rounded-md dark:text-gray-400 hover:cursor-pointer">
            Create Another
            <input type="checkbox" name="Stories" />
          </div>
          <div className="flex gap-3 items-center px-2 py-1 rounded-md">
            <button
              type="button"
