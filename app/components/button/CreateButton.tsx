        ...
        <div className="dark:bg-[#1f2532]">
          ...
          >
            <div className="w-[75%] max-lg:w-[100%]">
              ...
              <form className="my-2">
                ...
                >
                  ...
                  {isWrite === 1 ? (
                    <div class="pb-2 px-4 bg-white rounded-b-lg dark:bg-gray-800 xl:before:content-[''] xl:before:block xl:before:relative xl:before:w-[94.2%] xl:before:ml-[48.8px] xl:before:border-t-[1px] xl:before:border-[#e4e8eb] border-r-[1px] border-b-[1px] border-l-[1px] border-[#e4e8eb]">
                    ...
                    <div class="pb-2 px-4 bg-white rounded-b-lg dark:bg-gray-800 border-r-[1px] border-b-[1px] border-l-[1px] border-[#e4e8eb] xl:before:content-[''] xl:before:block xl:before:relative xl:before:w-[80.9%] xl:before:ml-[124px] xl:before:border-t-[1px] xl:before:border-[#e4e8eb]">
                      <label for="editor" className="sr-only">
                        Publish post
                      </label>
                      <textarea
            ...
            <div className="w-[25%] max-lg:w-[100%]">
              ...
              <button
                type="button"
                class="border-[1px] border-[#e4e8eb] dark:border-[#3f4a5f] rounded-md px-1 py-1 hover:bg-white hover:shadow-[0_1px_0_#0000001f] text-xs dark:text-[#f6f6f6] mb-5 dark:hover:bg-[#161b26]"
              >
          ...
          <div className="footer bg-white dark:bg-[#161b26f2] border-t-[1px] dark:border-[#3f4a5f] border-[#e4e8eb] py-4 flex justify-between px-4 rounded-bl-[12px] rounded-br-[12px]">
            ...
            <div className="flex">
              <div class="flex gap-3 items-center px-2 py-1 hover:bg-[#e4e8eb] dark:hover:bg-[black] dark:hover:border-[1px] dark:hover:border-[#e4e8eb] rounded-md dark:text-gray-400 hover:cursor-pointer">
                Create Another
