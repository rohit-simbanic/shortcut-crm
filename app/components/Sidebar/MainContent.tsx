...
const MainContent = () => {
  ...
  const [isTableViewTwo, setIsTableViewTwo] = useState(false);
  const [isScheduledView, setIsScheduledView] = useState(false);
  const [isScheduledViewTwo, setIsScheduledViewTwo] = useState(false);
  ...
  const toggleViewTableTwo = () => {
    setIsTableViewTwo((prevState) => !prevState);
  };

  const toggleScheduledTableTwo = () => {
    setIsScheduledViewTwo((prevState) => !prevState);
  };
  return (
    <div
    ...
    >
      ...
      {isTableView ? (
        <>
          <div
            className="h-[auto] overflow-y-auto overflow-x-none"
            id="tableView"
          >
            ...
            <div className="my-3 w-full">
              ...
              >
                <div className="flex gap-2 sticky top-0 z-10 bg-white dark:bg-[#1f2532]">
                  <div
                    className="flex items-center space-x-2 px-3 mr-8 rounded-md duration-500 ease-in-out py-2 cursor-pointer hover:bg-[#e4e8eb] hover:text-[#1f2532] dark:hover:bg-white dark:hover:text-[#635fc7] dark:text-white"
                    onClick={toggleScheduledTableTwo}
                  >
                    <svg
                      viewBox="0 0 20 20"
                      fill="none"
