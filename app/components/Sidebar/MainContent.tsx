    ...
    >
      ...
      {isTableView ? (
        <div className="overflow-x-auto my-3 bg-white">
          <div className=" shadow-[rgba(0, 0, 0, 0.06) 0px 3px 9px, rgba(0, 0, 0, 0.12) 0px 1px 3px] rounded-[8px] p-[8px]">
            <div className="flex gap-2">
              <div
            ...
            {isScheduledView && (
              <table className="w-full">
                <thead>
                  <tr className="text-md font-semibold tracking-wide text-left text-gray-900 bg-white uppercase border-gray-600 border-t-[1px] border-t-[#0000000d] shadow-[rgba(0, 0, 0, 0.04) 0px 4px 0px 0px]">
                    ...
                    <th className="px-4 font-normal hover:bg-[#e4e8eb] hover:cursor-pointer min-w-[120px]">
                      Name
                    </th>
                    <th className="px-4 font-normal hover:bg-[#e4e8eb] hover:cursor-pointer min-w-[120px]">
                      Workflow
