        ...
        <div className="overflow-y-auto h-[95vh] pr-[1rem]" id="sidebarRight">
          ...
          {isOpen ? (
            ...
            >
              ...
              >
                <p className="text-[#686c73] font-bold">Default Team</p>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <div className=" dark:bg-black w-full py-4 rounded-xl">
                ...
                <div className="dropdown-borad flex flex-col h-[70vh]  justify-between">
                  <div className="relative">
                    ...
                    <button
                      className="flex justify-center text-[#686c73] font-bold items-center shadow-[rgba(0,0,0,0.1)_0px_1px_0px] py-1 px-3 rounded-[5px] border-[1px] border-[#e4e8eb] bg-[#fff] hover:bg-[#f8f9fb] w-full my-5 dark:bg-[#161b26] dark:hover:bg-black dark:border-gray-300"
