...
import ActivityModal from "../modals/AcitivityModal";
      ...
      <nav className="flex flex-col sm:flex-row overflow-x-auto scrollbar-input dark:border-b-[#3f4a5f] items-center justify-between">
        ...
        <div className="relative">
          <svg
            ...
            onClick={() => setOpenActivityModal(!openActivityModal)}
            ...
            <ul>
              <li className="px-1 py-3 hover:bg-gray-100 rounded-md font-bold flex items-center justify-between gap-5 dark:hover:bg-[#161b26]">
                <div className="flex items-center gap-2">
                  <button
                    className="py-1 rounded-[50%] px-1 text-center h-[40px] w-[40px] align-middle font-sans flex items-center justify-center shrink-0 text-xs font-bold text-gray-50  transition-all bg-[#a32c3c] hover:text-white active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    type="button"
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Wrong Calculation on Repeat - Monthly
                      </strong>{" "}
                      in{" "}
                      <strong className="hover:cursor-pointer">
                        in development
              ...
              <li className="px-1 py-3 hover:bg-gray-100 rounded-md font-bold flex items-center justify-between gap-5 dark:hover:bg-[#161b26]">
                <div className="flex items-center gap-2">
                  <button
                    className="py-1 rounded-[50%] px-1 text-center h-[40px] w-[40px] align-middle font-sans flex items-center justify-center shrink-0 text-xs font-bold text-gray-50  transition-all bg-[#CCBA45] hover:text-white active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    type="button"
                    data-ripple-light="true"
                  >
                    RM
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      created{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Calculation does not show if End time select previously
                      </strong>{" "}
                      in{" "}
                      <strong className="hover:cursor-pointer">
                        Unscheduled
              ...
              <li className="px-1 py-3 hover:bg-gray-100 rounded-md font-bold flex items-center justify-between gap-5 dark:hover:bg-[#161b26]">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      <strong className="hover:cursor-pointer">You</strong>{" "}
                      commented on{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Make right sidebar double check for perfection in all
                        resolution
                      </strong>{" "}
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@ketulpatel</strong> default team modal & filter
                      modal overlap fixed and fixed the height issue after
                      toggling all toggle button. Thanks
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      marked{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        dark mode search bar should be similar like shortcut
                      </strong>{" "}
                      as <i>complete</i> by moving it to the{" "}
                      <strong className="hover:cursor-pointer">Complete</strong>
                    </h4>
                  </div>
                </div>
                <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      commented on{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Make left sidebar scrollbar more prominent like shortcut
                      </strong>{" "}
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@ketulpatel,</strong> i have fixed the dark mode
                      ui. Thanks
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Overlap spaces pop up and state of story box
                      </strong>{" "}
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@rohitmondal</strong> I have tested Overlap spaces
                      pop up and state of story box and it is working fine now
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      commented on{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        When sticky, it should not overlap any text on left
                        side.
                      </strong>{" "}
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@ketulpatel</strong> it is fixed now. Thanks
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      commented on{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        create a popup form for each item of table item name
                      </strong>
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@ketulpatel</strong> the popup is working now when
                      you click flutter app development
                    </div>
                  </div>
                </div>
                <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="dark:text-gray-100 text-[#686c73] text-[14px] font-normal">
                      ...
                      commented on{" "}
                      <strong className="text-[#1f2532] dark:text-[#b8b8bd] hover:cursor-pointer">
                        Add some features on Add Quick Filters pop up window
                      </strong>{" "}
                    </h4>
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@rohitmondal,</strong> I have tested Add some
                      features on Add Quick Filters pop up window and it looks
                      exactly as per expected. Please look at the attached
                      screenshot ui. Thanks
                      <Image
              ...
              <li className="px-1 py-3 hover:bg-gray-100 rounded-md font-bold flex items-center justify-between gap-5 dark:hover:bg-[#161b26]">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="relative dark:text-gray-100 text-[#686c73] text-[14px] font-normal rounded-md bg-[#f8f9fb] px-[16px] py-[14px] my-4 ml-5 border-[1px] border-[#e4e8eb] before:content-[''] before:block before:absolute before:w-[15px] before:left-[-24px] before:border-l-[2px] before:border-l-[#e4e8eb] before:border-b-[2px] before:border-b-[#e4e8eb] before:h-[15px] before:rounded-bl-lg dark:bg-[#0b101a] dark:border-[#283040]">
                      <strong>@ketulpatel</strong> I have tested Need to
                      highlight these icons in dark mode and it is work as
                      expected. Thanks
                    </div>
                  </div>
                </div>
